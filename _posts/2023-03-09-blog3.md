...
$$\begin{cases}E_\theta =-\frac{q}{4\pi \varepsilon _{0}c^{2}}[\frac{a(t-r/c)}{r} ]sin\theta
 ...
 \\
 \\P=\int SdA=\frac{q^2\omega ^4}{12\pi \varepsilon _0c^3} \hat{x} ^2
 \\
 \\Q=\frac{W}{dW/d\phi }=\frac{\omega W}{dW/dt}=\frac{\omega W}{P}=\frac{\omega _{0} }{\bigtriangleup \omega }=\frac{\omega _0}{\gamma }
 \\
