...
衍射与干涉的知识与前文相比还是好理解的,这一块不准备细讲,但是还是想提醒自己时刻保持图解法分析问题的意识。以衍射光栅的分辨能力问题为例：当N条刻痕的光线矢量图收尾相接刚好转过$$2 \pi$$时，有最小的光强，即$$\lambda sin\theta =Nd$$。所以光栅的分辨本领为$$R=\lambda/\bigtriangleup \lambda =kN$$。

<div align = center>
<img src="/post-img/blog3/b3_6.jpg">
</div>
